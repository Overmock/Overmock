...
namespace Overmock.Tests
{
    ...
    public class VerifiableTests
    {
        ...
        public void Initialize()
        {
            ...
            {
                var work = Worker.Write("I overwrote the original method to call this.");
            });
            ...
            {
                var obj1 = c.Get<Model>("o1"); // f.GoDoYourWork o1
                var obj2 = c.Get<string>(2); // f.GoDoYourWork o2

                // TODO: I don't know if we should allow them to return here?
                return Worker.Work(new Model());
            });
            ...
            _interface.Override(i => i.Factory)
                .ToThrow(new NullReferenceException());
                //.Returns(() => new Factory2Ctor(_provider.Object));
        }

        [TestMethod]
        public void OverridingInterfaceMethodToThrow()
        {
            // Arrange
        ...
        [TestMethod]
        public void OverridingInterfacePropertyToThrow()
        {
            // Arrange
            _controller = new Controller(_interface.Object, _factory.Object, _provider.Object);

            // Act
            var result = _controller.DoSomeWorkWithProperties();
