...
//        {
//            if (!interfaceType.GetTypeInfo().IsPublic || !interfaceType.GetTypeInfo().IsInterface)
//            {
...
//            lock (_lock)
//            {
//                var name = GetInterfaceImplTypeFullName(interfaceType);
...
//			return $"{ProxyNameSpace}.{className}{nameof(Overmocked)}";//GetProxyTypeIndex(className, interfaceType, interfaceType)}";
//		}
...
//		//        internal Type CreateClassProxy(Type serviceType, Type implType, Type[] additionalInterfaces)
//		//        {
//		//            if (!serviceType.GetTypeInfo().IsPublic || !serviceType.GetTypeInfo().IsClass)
//		//            {
...
//		//                {
//		//                    if (method.IsPublic && !ignores.Contains(method.Name))
//		//                        DefineClassMethod(method, implType, typeDesc);
//		//                }
//		//                foreach (var item in additionalInterfaces)
//		//                {
//		//                    foreach (var method in item.GetTypeInfo().DeclaredMethods.Where(x => false))//!x.IsPropertyBinding()))
//		//                    {
...
//		//                {
//		//                    if (property.IsPublicAndVirtual())
//		//                    {
//		//                        var builder = DefineInterfaceProxyProperty(property, property.Name, implType, typeDesc);
