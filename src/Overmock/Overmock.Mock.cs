...
namespace Overmocked
{
    ...
    public static partial class Overmock
    {
        ...
        /// <param name="expression">The use.</param>
        /// <returns>ISetup&lt;T&gt;.</returns>
        public static ISetup<T, TReturn> Mock<T, TReturn>(T target, Expression<Func<T, TReturn>> expression) where T : class
        {
            return GetOvermock(target).Mock(expression);
        }
        ...
        /// <param name="expression">The use.</param>
        /// <returns>ISetup&lt;T&gt;.</returns>
        public static ISetup<T, TReturn> Mock<T, TReturn>(IOvermock<T> overmock, Expression<Func<T, TReturn>> expression) where T : class
        {
            return overmock.Mock(expression);
        }
    }
