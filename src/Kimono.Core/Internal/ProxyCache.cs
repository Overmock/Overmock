...
namespace Kimono.Core.Internal
{
    ...
    /// Implements the <see cref="IProxyCache" />
    /// </summary>
    /// <seealso cref="IProxyCache" />
    internal sealed class ProxyCache : IProxyCache
    {
        /// <summary>
        /// The cache
        /// </summary>
        ...
        /// The proxy cache
        /// </summary>
        private static readonly IProxyCache _proxyCache = new ProxyCache();

        /// <summary>
        /// Prevents a default instance of the <see cref="ProxyCache"/> class from being created.
        /// </summary>
        private ProxyCache()
        {
        }
        ...
        public static IProxyCache Instance => _proxyCache;
